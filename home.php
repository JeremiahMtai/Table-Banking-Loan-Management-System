			...
			<div class="card">
				...
				<div class="col-md-3">
                        <div class="card bg-success text-white mb-5">
                            <img src="assets/img/loan-cover.jpg" class="card-img-top rounded-circle" alt="">
                            <div class="card-body">
                ...
                <div class="col-md-3">
                        ...
                        <img style="height: 150px;" src="assets/img/borrower.jpg" class="card-img-top rounded-circle" alt="">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                  ...
                  <div class="col-md-3">
                        ...
                        <img src="assets/img/active-loan.jpg" class="card-img-top rounded-circle" alt="">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                ...
                <div class="col-md-3">
                        ...
                        <img style="height: 150px;" src="assets/img/total-receivable.jpg" class="card-img-top rounded-circle" alt="">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
