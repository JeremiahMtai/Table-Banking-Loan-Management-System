		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					<b>Payment List</b> &nbsp;&nbsp;
					<img style="height: 40px; width: 40px; float:right;" src="assets/img/plus.jpg"  class="rounded-circle" alt="plus icon"> &nbsp; <button class="btn btn-success btn-sm btn-block col-md-2 float-right" type="button" id="new_payments"><!--<i class="fa fa-plus"></i>-->  New Payment</button>
				</large>
